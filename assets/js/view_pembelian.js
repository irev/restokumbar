$(document).ready(function(){
	...
	$("#view_sales").click(function(){
		...
		var link = url+'pembelian/LaporanPertahun?tahun='+tahun;
		if(tahun==''){
			alert("Tahun Kosong !!");
		}else{
	...
	$(".hapus").click(function(event){
		...
		$.ajax({
			url: url+'pembelian/Delete?no_struk='+no_struk,
	...
	$("#daftar").click(function(){
		var awal = $("#awal").val();
		var akhir = $("#akhir").val();
		var link = url+'pembelian/LaporanPerdaftar?awal='+awal+'&&akhir='+akhir;
		if(awal==''||akhir==''){
	...
	$("#periode").click(function(){
		var awal = $("#awal").val();
		var akhir = $("#akhir").val();
		var link = url+'pembelian/LaporanPerperiode?awal='+awal+'&&akhir='+akhir;
		if(awal==''||akhir==''){
			alert('Tanggal ada yang kosong !!');
		}else{
			window.open(link, 'cetak', 'window settings'); 
	...
	function ShowDetail(no_struk){
		$.ajax({
			url: url+'pembelian/ShowDetail?no_struk='+no_struk,
			type: 'json',
			success: function(data){
				$("#tobar").text('');
				var list = eval(data);
